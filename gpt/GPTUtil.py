...
class GPTUtil:
    ...
    @staticmethod
    def execute(text, model = get_env_setting(gpt_env, gpt_default_model_env)):
        ...
        client = OpenAI(api_key=get_env_setting(gpt_env, gpt_token_env))
        messages = [
        ...
        print(f"Success GPT Conversation, Model : {model}")
